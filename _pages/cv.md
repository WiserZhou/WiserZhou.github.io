...
- **Information**: [CV-PDF](../files/CV.pdf)
...
- **Research Learning Process**: Started exploring deep learning during the winter break of sophomore year, self-studied
  some work in NLP and multi-model fields. In the second semester of sophomore year, focused on the Diffusion direction,
  learned the mathematical principles, and understood the latest progress in Diffusion. Currently running code and
  refining models.
- **Research Mentor**: Under the guidance of Professor Qi Zhaobo in the school laboratory, conducted paper
  presentations, and planned to apply Diffusion in procedure planning.
